...
class EC_Cat_List_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Cat List Checkboxes', 'ecfilter' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'ecfilter' ),
    ...
    $this->add_control(
			'el_list_title',
			[
				'label' => esc_html__( 'List title', 'ecfilter' ),
		...
		$this->add_control(
			'el_list_tax',
			[
				'label' => esc_html__( 'List Tax', 'ecfilter' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			'el_all_text',
			[
				'label' => esc_html__( 'All Text', 'ecfilter' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
